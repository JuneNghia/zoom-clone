...
export const viVN: LocalizationResource = {
  ...
  dates: {
    ...
    next6Days:
      "Vào {{ date | weekday('vi-VN','long') }} tới lúc {{ date | timeString('vi-VN') }}",
    nextDay: "Ngày mai lúc {{ date | timeString('vi-VN') }}",
    numeric: "{{ date | numeric('vi-VN') }}",
    previous6Days:
      "Vào {{ date | weekday('vi-VN','long') }} trước đó lúc {{ date | timeString('vi-VN') }}",
  ...
  signIn: {
    ...
    noAvailableMethods: {
      message:
        'Không thể tiếp tục đăng nhập. Không có phương thức xác thực nào khả dụng.',
    ...
    resetPassword: {
      ...
      successMessage:
        'Mật khẩu của bạn đã được thay đổi thành công. Đang đăng nhập, vui lòng chờ một chút.',
      title: 'Đặt lại mật khẩu',
    },
    resetPasswordMfa: {
      detailsLabel:
        'Chúng tôi cần xác minh danh tính của bạn trước khi đặt lại mật khẩu.',
    },
    start: {
      actionLink: 'Đăng ký',
  ...
  signUp: {
    ...
    emailLink: {
      formSubtitle:
        'Sử dụng liên kết xác minh đã được gửi đến địa chỉ email của bạn',
      formTitle: 'Liên kết xác minh',
      loading: {
        title: 'Đang đăng ký...',
      },
  ...
  unstable__errors: {
    ...
    form_param_format_invalid__email_address:
      'Địa chỉ email phải là một địa chỉ email hợp lệ',
    ...
    identification_deletion_failed:
      'Bạn không thể xóa thông tin nhận dạng cuối cùng của bạn.',
    not_allowed_access: '',
    passwordComplexity: {
    ...
    zxcvbn: {
      couldBeStronger:
        'Mật khẩu của bạn đủ mạnh, nhưng có thể mạnh hơn. Hãy thêm nhiều ký tự hơn.',
      ...
      suggestions: {
        ...
        longerKeyboardPattern:
          'Sử dụng các mẫu bàn phím dài hơn và thay đổi hướng gõ nhiều lần.',
        noNeed:
          'Bạn có thể tạo mật khẩu mạnh mà không cần sử dụng ký tự đặc biệt, số hoặc chữ cái viết hoa.',
        pwned:
          'Nếu bạn sử dụng mật khẩu này ở những nơi khác, bạn nên thay đổi nó.',
      ...
      warnings: {
        ...
        pwned:
          'Mật khẩu của bạn đã bị rò rỉ qua một cuộc tấn công dữ liệu trên Internet.',
        ...
        userInputs:
          'Không nên có bất kỳ dữ liệu cá nhân hoặc liên quan đến trang web.',
  ...
  userProfile: {
    ...
    connectedAccountPage: {
      ...
      formHint__noAccounts:
        'Không có nhà cung cấp tài khoản bên ngoài khả dụng.',
      removeResource: {
        ...
        successMessage:
          '{{connectedAccount}} đã được xóa khỏi tài khoản của bạn.',
    ...
    emailAddressPage: {
      emailCode: {
        formHint:
          'Một email chứa mã xác minh sẽ được gửi đến địa chỉ email này.',
        formSubtitle: 'Nhập mã xác minh được gửi đến {{identifier}}',
        formTitle: 'Mã xác minh',
        resendButton: 'Không nhận được mã? Gửi lại',
        successMessage:
          'Email {{identifier}} đã được thêm vào tài khoản của bạn.',
      },
      emailLink: {
        formHint:
          'Một email chứa liên kết xác minh sẽ được gửi đến địa chỉ email này.',
        formSubtitle:
          'Nhấp vào liên kết xác minh trong email được gửi đến {{identifier}}',
        formTitle: 'Liên kết xác minh',
        resendButton: 'Không nhận được liên kết? Gửi lại',
        successMessage:
          'Email {{identifier}} đã được thêm vào tài khoản của bạn.',
    ...
    mfaPhoneCodePage: {
      ...
      removeResource: {
        messageLine1:
          '{{identifier}} sẽ không còn nhận được mã xác thực khi đăng nhập.',
        messageLine2:
          'Tài khoản của bạn có thể không an toàn. Bạn có chắc chắn muốn tiếp tục không?',
        successMessage:
          'Xác thực hai bước bằng mã SMS đã được gỡ bỏ cho {{mfaPhoneCode}}',
        title: 'Gỡ bỏ xác thực hai bước',
      },
      subtitle__availablePhoneNumbers:
        'Chọn một số điện thoại để đăng ký xác thực hai bước bằng mã SMS.',
    ...
    mfaTOTPPage: {
      ...
      removeResource: {
        ...
        messageLine2:
          'Tài khoản của bạn có thể không an toàn. Bạn có chắc chắn muốn tiếp tục không?',
        successMessage:
          'Xác thực hai bước qua ứng dụng xác thực đã được gỡ bỏ.',
        title: 'Gỡ bỏ xác thực hai bước',
      },
      successMessage:
    ...
    passwordPage: {
      ...
      readonly:
        'Hiện tại bạn không thể chỉnh sửa mật khẩu vì bạn chỉ có thể đăng nhập qua kết nối doanh nghiệp.',
      successMessage__set: 'Mật khẩu của bạn đã được thiết lập.',
      successMessage__signOutOfOtherSessions:
        'Tất cả các thiết bị khác đã được đăng xuất.',
    ...
    phoneNumberPage: {
      infoText:
        'Một tin nhắn chứa liên kết xác minh sẽ được gửi đến số điện thoại này.',
      removeResource: {
        messageLine1: '{{identifier}} sẽ bị xóa khỏi tài khoản này.',
    ...
    profilePage: {
      fileDropAreaHint:
        'Tải lên ảnh JPG, PNG, GIF, hoặc WEBP có dung lượng nhỏ hơn 10 MB',
      imageFormDestructiveActionSubtitle: 'Xóa ảnh',
      imageFormSubtitle: 'Tải ảnh lên',
      imageFormTitle: 'Hình ảnh hồ sơ',
      readonly:
        'Thông tin hồ sơ của bạn đã được cung cấp bởi kết nối doanh nghiệp và không thể chỉnh sửa.',
    ...
    start: {
      ...
      headerTitle__account: 'Thông tin cá nhân',
    ...
    web3WalletPage: {
      ...
      subtitle__availableWallets:
        'Chọn một ví web3 để kết nối với tài khoản của bạn.',
